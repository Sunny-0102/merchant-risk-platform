...
ALTER TABLE mrp.merchant_feature_snapshots
  ...
  ADD COLUMN IF NOT EXISTS local_model_score NUMERIC(6,5),
  ADD COLUMN IF NOT EXISTS local_model_band TEXT,
  ADD COLUMN IF NOT EXISTS local_model_version TEXT,
  ADD COLUMN IF NOT EXISTS local_model_scored_at_utc TIMESTAMPTZ;
