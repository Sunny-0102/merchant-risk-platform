...
""",
        ...
        CREATE TABLE IF NOT EXISTS mrp.merchant_feature_snapshots (
          ...
          local_model_score        NUMERIC(6,5),
          local_model_band         TEXT,
          local_model_version      TEXT,
          local_model_scored_at_utc TIMESTAMPTZ,
        ...
        "ALTER TABLE mrp.merchant_feature_snapshots ADD COLUMN IF NOT EXISTS local_model_score NUMERIC(6,5);",
        "ALTER TABLE mrp.merchant_feature_snapshots ADD COLUMN IF NOT EXISTS local_model_band TEXT;",
        "ALTER TABLE mrp.merchant_feature_snapshots ADD COLUMN IF NOT EXISTS local_model_version TEXT;",
        "ALTER TABLE mrp.merchant_feature_snapshots ADD COLUMN IF NOT EXISTS local_model_scored_at_utc TIMESTAMPTZ;",
